...
async function main()
{
  ...
  const apiUrl =
    `https://api.github.com/repos/${args.owner}/${args.repo}/actions/workflows/${workflowFileName}/dispatches`;
  ...
  const payload = {
    ...
    inputs: {
      ...
      proposedChangesJson: args.changeJson, // Pass the JSON string directly
      dryRun: args.dryRun,
    },
  };

  console.log(
    `Triggering workflow '${workflowFileName}' on ref '${payload.ref}' for repo ${args.owner}/${args.repo}...`,
  );
